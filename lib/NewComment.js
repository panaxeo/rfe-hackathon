...
var NewComment = /** @class */ (function (_super) {
    ...
    function NewComment() {
        ...
        _this.state = { warningVisible: false };
    ...
    NewComment.prototype.render = function () {
        ...
        return (React.createElement(React.Fragment, null,
            ...
            React.createElement(BadWordsWarningWrapper, { visible: this.state.warningVisible },
                React.createElement(SoundWave, null)),
            React.createElement(BadWordsWarningLabelWrapper, { visible: this.state.warningVisible },
                React.createElement(Label, { type: "warning", style: { marginTop: 32, display: 'block', float: 'left' } }, "Are you sure you want to post this comment?")),
